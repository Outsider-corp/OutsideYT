...
from outside.YT_functions import get_playlist_info, get_video_info, select_page
...
def open_watch_select_videos(parent, table: QtWidgets.QTableView, parent_settings):
    ...
    def import_links_from_file():
        ...
        start_operation(
            ...
            process=partial(import_links_process, file))

    def import_links_process(file):
    ...
    def ok():
        ...
        if url == '':
            ...
            dialog_settings.Group_comboBox.currentText()
