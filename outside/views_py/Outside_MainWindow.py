...
"selection-background-color: rgb(15, 15, 15);")
        ...
        self.Download_SavingPath_Label.setMinimumSize(QtCore.QSize(250, 0))
        self.Download_SavingPath_Label.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.Download_SavingPath_Label.setFont(font)
        self.Download_SavingPath_Label.setText("")
        self.Download_SavingPath_Label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.Download_SavingPath_Label.setObjectName("Download_SavingPath_Label")
        self.horizontalLayout_8.addWidget(self.Download_SavingPath_Label)
        ...
        self.horizontalLayout_8.addWidget(self.Download_ChangePath_Button)
        ...
        spacerItem18 = QtWidgets.QSpacerItem(11, 3, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem20 = QtWidgets.QSpacerItem(40, 50, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
