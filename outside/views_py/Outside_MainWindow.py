...
"selection-background-color: rgb(15, 15, 15);")
        ...
        self.Download_UserMode_checkBox = QtWidgets.QCheckBox(self.DownloadPage)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(11)
        self.Download_UserMode_checkBox.setFont(font)
        self.Download_UserMode_checkBox.setChecked(True)
        self.Download_UserMode_checkBox.setObjectName("Download_UserMode_checkBox")
        self.verticalLayout_3.addWidget(self.Download_UserMode_checkBox)
        self.Download_OwnerMode_checkBox = QtWidgets.QCheckBox(self.DownloadPage)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(11)
        self.Download_OwnerMode_checkBox.setFont(font)
        self.Download_OwnerMode_checkBox.setObjectName("Download_OwnerMode_checkBox")
        self.verticalLayout_3.addWidget(self.Download_OwnerMode_checkBox)
    ...
    def retranslateUi(self, YouTubeOutside):
        ...
        self.Download_UserMode_checkBox.setText(_translate("YouTubeOutside", "User Mode"))
        self.Download_OwnerMode_checkBox.setText(_translate("YouTubeOutside", "Owner Mode"))
