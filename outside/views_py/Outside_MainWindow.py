...
"selection-background-color: rgb(15, 15, 15);")
        ...
        self.Download_UserMode_radioButton = QtWidgets.QRadioButton(self.DownloadPage)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(11)
        self.Download_UserMode_radioButton.setFont(font)
        self.Download_UserMode_radioButton.setChecked(True)
        self.Download_UserMode_radioButton.setObjectName("Download_UserMode_radioButton")
        self.verticalLayout_3.addWidget(self.Download_UserMode_radioButton)
        self.Download_OwnerMode_radioButton = QtWidgets.QRadioButton(self.DownloadPage)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(11)
        self.Download_OwnerMode_radioButton.setFont(font)
        self.Download_OwnerMode_radioButton.setObjectName("Download_OwnerMode_radioButton")
        self.verticalLayout_3.addWidget(self.Download_OwnerMode_radioButton)
        ...
        self.Download_Owner_label = QtWidgets.QLabel(self.DownloadPage)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(11)
        self.Download_Owner_label.setFont(font)
        self.Download_Owner_label.setObjectName("Download_Owner_label")
        self.horizontalLayout_8.addWidget(self.Download_Owner_label)
        self.Download_Owner_ComboBox = QtWidgets.QComboBox(self.DownloadPage)
        self.Download_Owner_ComboBox.setMinimumSize(QtCore.QSize(100, 0))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(11)
        self.Download_Owner_ComboBox.setFont(font)
        self.Download_Owner_ComboBox.setObjectName("Download_Owner_ComboBox")
        self.horizontalLayout_8.addWidget(self.Download_Owner_ComboBox)
        ...
        spacerItem19 = QtWidgets.QSpacerItem(11, 3, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem21 = QtWidgets.QSpacerItem(40, 50, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1031, 18))
        ...
        self.menuUsers_Lists.addAction(self.actionDownloaders)
    ...
    def retranslateUi(self, YouTubeOutside):
        ...
        self.Download_UserMode_radioButton.setText(_translate("YouTubeOutside", "User Mode"))
        self.Download_OwnerMode_radioButton.setText(_translate("YouTubeOutside", "Owner Mode"))
        self.Download_Owner_label.setText(_translate("YouTubeOutside", "Select Owner"))
