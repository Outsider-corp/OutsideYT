...
# Form implementation generated from reading ui file 'P:\PROJECTS\OutsideYT\outside\views_ui\AddWatcher_Dialog.ui'
#
...
class Ui_AddUser_Dialog(object):
    def setupUi(self, AddUser_Dialog):
        ...
        AddUser_Dialog.setMaximumSize(QtCore.QSize(600, 400))
...
'selection-background-color: rgb(15, 15, 15);')
        ...
        self.label_3 = QtWidgets.QLabel(AddUser_Dialog)
        font = QtGui.QFont()
        font.setFamily('Arial')
        font.setPointSize(11)
        ...
        self.Group_comboBox = QtWidgets.QComboBox(AddUser_Dialog)
        font = QtGui.QFont()
        font.setFamily('Arial')
        font.setPointSize(11)
        self.Group_comboBox.setFont(font)
        self.Group_comboBox.setObjectName('Group_comboBox')
        self.verticalLayout.addWidget(self.Group_comboBox)
    ...
    def retranslateUi(self, AddUser_Dialog):
        ...
        AddUser_Dialog.setWindowTitle(_translate('AddUser_Dialog', 'Add Account'))
        ...
        self.label_3.setText(_translate('AddUser_Dialog', 'Group'))
